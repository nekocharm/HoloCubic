...
static lv_font_maiyuan_24_bmp_t maiyuan_24[50]={
    {
        .unicode=0,
    }
};
static lv_font_maiyuan_24_dsc_t maiyuan_24_dsc[50]={
    {
        .unicode=0,
    }
};
...
static void __user_font_getdata(int offset, int size, uint8_t* buf){
    ...
    if(fontisopen==0){
        lv_fs_open(&font_f,"S:/font/lv_font_maiyuan_24.bin",LV_FS_MODE_RD);
        fontisopen=1;
    }
